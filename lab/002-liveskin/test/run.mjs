...
check('每套皮肤都能推导出「亮/暗两档分别是什么样」，且与已知事实一致', () => {
  ...
  const expected = {
    ...
    // 星际争霸三族：每个变体都必须两档都成立（这是这一批的硬要求）
    'TerranFamily/DominionOutpost': 'light/dark',
    'TerranFamily/MarSaraDusk': 'light/dark',
    'TerranFamily/GhostOps': 'light/dark',
    'TerranFamily/BarracksDeck': 'light/dark',
    'ZergFamily/HiveCluster': 'light/dark',
    'ZergFamily/BroodPit': 'light/dark',
    'ZergFamily/LeviathanHull': 'light/dark',
    'ZergFamily/CreepField': 'light/dark',
    'ProtossFamily/AiurTemple': 'light/dark',
